...
class MusicPlayer:
    ...
    def basic_setup(self):
        # Heading
        Label(self.window,text="Musifier Sigma", font=("Arial",20,"bold","italic"),bg="#141414",fg="gold").place(x=240,y=25)
